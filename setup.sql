-- --- 1. TABLES ---
CREATE TABLE IF NOT EXISTS VITALIS_SB.APP.CUSTOMER_SOURCE (SOURCE_ID VARCHAR PRIMARY KEY, SOURCE_NAME VARCHAR, IS_ACTIVE BOOLEAN DEFAULT TRUE);
...
-- SP: Add Customer
CREATE OR REPLACE PROCEDURE VITALIS_SB.APP.SP_ADD_CUSTOMER(
...
CREATE OR REPLACE PROCEDURE VITALIS_SB.APP.SP_UPDATE_CUSTOMER(
    p_id VARCHAR, p_name VARCHAR, p_email VARCHAR, p_phone VARCHAR,
...
-- SP: Update Notes
CREATE OR REPLACE PROCEDURE VITALIS_SB.APP.SP_UPDATE_NOTES(p_id VARCHAR, p_notes VARCHAR, p_user VARCHAR)
RETURNS VARCHAR LANGUAGE SQL AS $$
BEGIN
...
-- SP: Delete Customer
CREATE OR REPLACE PROCEDURE VITALIS_SB.APP.SP_DELETE_CUSTOMER(p_id VARCHAR, p_user VARCHAR)
RETURNS VARCHAR LANGUAGE SQL AS $$
BEGIN
...
-- SP: Add Report
CREATE OR REPLACE PROCEDURE VITALIS_SB.APP.SP_ADD_REPORT(p_report_id VARCHAR, p_customer_id VARCHAR, p_filename VARCHAR, p_stage_path VARCHAR, p_user VARCHAR)
RETURNS VARCHAR LANGUAGE SQL AS $$
BEGIN
...
-- SP: Delete Report
CREATE OR REPLACE PROCEDURE VITALIS_SB.APP.SP_DELETE_REPORT(p_report_id VARCHAR, p_customer_id VARCHAR, p_user VARCHAR)
RETURNS VARCHAR LANGUAGE SQL AS $$
BEGIN
...
-- SP: Extract Report
CREATE OR REPLACE PROCEDURE VITALIS_SB.APP.SP_EXTRACT_REPORT(
